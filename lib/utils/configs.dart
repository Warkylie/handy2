...
const APP_NAME = 'Hizmeting';
const APP_NAME_TAG_LINE = 'Anında Hizmet Anında Çözüm';
var defaultPrimaryColor = Color(0xFF00BD4F);

const DOMAIN_URL = 'apps.iqonic.design/handyman';
...
const HELP_LINE_NUMBER = '0850 ';

/// STRIPE PAYMENT DETAIL
const STRIPE_MERCHANT_COUNTRY_CODE = 'TR';
const STRIPE_CURRENCY_CODE = 'TRY';
DateTime todayDate = DateTime(2023, 6, 10);
